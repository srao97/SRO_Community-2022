...
import { OMNIDEF } from './vHFFinalPaymentEnglish_def.js';
import tmpl from './vHFFinalPaymentEnglish.html';
import tmpl_nds from './vHFFinalPaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFFinalPaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
