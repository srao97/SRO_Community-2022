...
import { OMNIDEF } from './vHFConfirmRefinanceEnglish_def.js';
import tmpl from './vHFConfirmRefinanceEnglish.html';
import tmpl_nds from './vHFConfirmRefinanceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFConfirmRefinanceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
