...
import { OMNIDEF } from './vHFAdditionalInformationEnglish_def.js';
import tmpl from './vHFAdditionalInformationEnglish.html';
import tmpl_nds from './vHFAdditionalInformationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFAdditionalInformationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
