...
import { OMNIDEF } from './vHFLIECalculatorEnglish_def.js';
import tmpl from './vHFLIECalculatorEnglish.html';
import tmpl_nds from './vHFLIECalculatorEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFLIECalculatorEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
