...
import { OMNIDEF } from './vHFCreateCasesEnglish_def.js';
import tmpl from './vHFCreateCasesEnglish.html';
import tmpl_nds from './vHFCreateCasesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFCreateCasesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
