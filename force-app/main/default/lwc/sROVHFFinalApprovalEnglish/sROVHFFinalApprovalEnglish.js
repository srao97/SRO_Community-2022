...
import { OMNIDEF } from './sROVHFFinalApprovalEnglish_def.js';
import tmpl from './sROVHFFinalApprovalEnglish.html';
import tmpl_nds from './sROVHFFinalApprovalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sROVHFFinalApprovalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
