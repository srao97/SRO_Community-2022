...
import { OMNIDEF } from './vHFSubmitRenovationRequestEnglish_def.js';
import tmpl from './vHFSubmitRenovationRequestEnglish.html';
import tmpl_nds from './vHFSubmitRenovationRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFSubmitRenovationRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
