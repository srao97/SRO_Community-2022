...
import { OMNIDEF } from './vHFAnnualReviewVerificationEnglish_def.js';
import tmpl from './vHFAnnualReviewVerificationEnglish.html';
import tmpl_nds from './vHFAnnualReviewVerificationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFAnnualReviewVerificationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
