...
import { OMNIDEF } from './vHFSaleOfPropertyEnglish_def.js';
import tmpl from './vHFSaleOfPropertyEnglish.html';
import tmpl_nds from './vHFSaleOfPropertyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFSaleOfPropertyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
