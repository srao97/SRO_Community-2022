...
import { OMNIDEF } from './vHFAnnualReviewEnglish_def.js';
import tmpl from './vHFAnnualReviewEnglish.html';
import tmpl_nds from './vHFAnnualReviewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFAnnualReviewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
