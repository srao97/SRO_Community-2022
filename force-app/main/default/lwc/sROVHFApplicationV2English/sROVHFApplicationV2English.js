...
import { OMNIDEF } from './sROVHFApplicationV2English_def.js';
import tmpl from './sROVHFApplicationV2English.html';
import tmpl_nds from './sROVHFApplicationV2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sROVHFApplicationV2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
