...
import { OMNIDEF } from './vHFPIACalculatorEnglish_def.js';
import tmpl from './vHFPIACalculatorEnglish.html';
import tmpl_nds from './vHFPIACalculatorEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFPIACalculatorEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
