...
import { OMNIDEF } from './vHFReportRefinanceOutcomeEnglish_def.js';
import tmpl from './vHFReportRefinanceOutcomeEnglish.html';
import tmpl_nds from './vHFReportRefinanceOutcomeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFReportRefinanceOutcomeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
