...
import { OMNIDEF } from './vHFAbsenceRequestEnglish_def.js';
import tmpl from './vHFAbsenceRequestEnglish.html';
import tmpl_nds from './vHFAbsenceRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFAbsenceRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
