...
import { OMNIDEF } from './vHFAnnualReviewMinorUpdateEnglish_def.js';
import tmpl from './vHFAnnualReviewMinorUpdateEnglish.html';
import tmpl_nds from './vHFAnnualReviewMinorUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFAnnualReviewMinorUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
