...
import { OMNIDEF } from './vHFSEICalculatorEnglish_def.js';
import tmpl from './vHFSEICalculatorEnglish.html';
import tmpl_nds from './vHFSEICalculatorEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFSEICalculatorEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
