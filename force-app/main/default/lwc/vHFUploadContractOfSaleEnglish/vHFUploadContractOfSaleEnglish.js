...
import { OMNIDEF } from './vHFUploadContractOfSaleEnglish_def.js';
import tmpl from './vHFUploadContractOfSaleEnglish.html';
import tmpl_nds from './vHFUploadContractOfSaleEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFUploadContractOfSaleEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
