...
import { OMNIDEF } from './vHFQuarterlyReportEnglish_def.js';
import tmpl from './vHFQuarterlyReportEnglish.html';
import tmpl_nds from './vHFQuarterlyReportEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFQuarterlyReportEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
