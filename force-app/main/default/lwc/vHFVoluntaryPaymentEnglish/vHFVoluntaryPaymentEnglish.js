...
import { OMNIDEF } from './vHFVoluntaryPaymentEnglish_def.js';
import tmpl from './vHFVoluntaryPaymentEnglish.html';
import tmpl_nds from './vHFVoluntaryPaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFVoluntaryPaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
