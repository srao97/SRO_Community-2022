...
import { OMNIDEF } from './vHFNewCaseEnglish_def.js';
import tmpl from './vHFNewCaseEnglish.html';
import tmpl_nds from './vHFNewCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFNewCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
