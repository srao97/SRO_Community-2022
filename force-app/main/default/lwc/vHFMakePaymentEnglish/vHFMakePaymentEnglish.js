...
import { OMNIDEF } from './vHFMakePaymentEnglish_def.js';
import tmpl from './vHFMakePaymentEnglish.html';
import tmpl_nds from './vHFMakePaymentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFMakePaymentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
