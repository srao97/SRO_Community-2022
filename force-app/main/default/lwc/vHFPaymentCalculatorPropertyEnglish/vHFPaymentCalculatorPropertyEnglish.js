...
import { OMNIDEF } from './vHFPaymentCalculatorPropertyEnglish_def.js';
import tmpl from './vHFPaymentCalculatorPropertyEnglish.html';
import tmpl_nds from './vHFPaymentCalculatorPropertyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFPaymentCalculatorPropertyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
