...
import { OMNIDEF } from './vHFSubmitRequestEnglish_def.js';
import tmpl from './vHFSubmitRequestEnglish.html';
import tmpl_nds from './vHFSubmitRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFSubmitRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
