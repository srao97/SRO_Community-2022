...
import { OMNIDEF } from './vHFWFCalculatorEnglish_def.js';
import tmpl from './vHFWFCalculatorEnglish.html';
import tmpl_nds from './vHFWFCalculatorEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFWFCalculatorEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
