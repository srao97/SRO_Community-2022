...
import { OMNIDEF } from './vHFGenerateCasesEnglish_def.js';
import tmpl from './vHFGenerateCasesEnglish.html';
import tmpl_nds from './vHFGenerateCasesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFGenerateCasesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
