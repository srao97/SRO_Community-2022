...
import { OMNIDEF } from './vHFSubmitRefinanceRequestEnglish_def.js';
import tmpl from './vHFSubmitRefinanceRequestEnglish.html';
import tmpl_nds from './vHFSubmitRefinanceRequestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFSubmitRefinanceRequestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
