...
import { OMNIDEF } from './vHFReportWindfallGainEnglish_def.js';
import tmpl from './vHFReportWindfallGainEnglish.html';
import tmpl_nds from './vHFReportWindfallGainEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class vHFReportWindfallGainEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
